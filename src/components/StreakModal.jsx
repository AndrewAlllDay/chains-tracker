...
import { Trophy, Zap, Snowflake, Target, Flame, X } from 'lucide-react';
...
const StreakModal = ({ isOpen, onClose, streak, milestone, history }) => {
    ...
    return (
        ...
        >
            {/* MODAL CONTENT */}
            <div
                className="modal-content streak-modal-content"
            ...
            >
                ...
                {/* Conditionally render the title so it doesn't leave an empty tag */}
                {milestone?.title && (
                ...
                {/* Conditionally render the message so it doesn't leave an empty tag */}
                {milestone?.msg && (
